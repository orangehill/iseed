...
#### Laravel 5 versions upragate 5.3.* to above than 5.4.15 
New laravel version work only 3.2.1 stable release, go your project's `composer.json` file to require `orangehill/iseed`.
